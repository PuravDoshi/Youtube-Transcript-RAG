...
def initialize_retriever(video_id):
    ...
    """
    # Fetch transcript and convert to raw text
...
if video_url:
    try:
        ...
        # Displays a loading state while the 'initialize_retriever' function runs
        ...
        if user_query:
            ...
            # Generate and display the answer immediately
